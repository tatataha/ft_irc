...
int        Client::getReceiver() { return this->receiver; }
...
void        Client::sender(std::string str) { send(this->socket, str.c_str(), str.size(), 0); }

void        Client::setReceiver(int receiver) { this->receiver = receiver; }
